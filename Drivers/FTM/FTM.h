...
#define OUTM_EN(x)(x) GPIO_SET(PORTA,3,x);GPIO_SET(PORTA,5,x)//电机A使能
typedef enum FTMn
{
    FTM0,
    FTM1,
...
void PWM_SET(int pwm_right,int pwm_left);//PWM设置
void MotorEN(u8 set);//电机使能
void FTM_SpeedMeasure_init();//A12,A13,B18,B19//正交解码初始化
